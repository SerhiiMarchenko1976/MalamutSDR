...
#define NONE           0x0000      // Juste pour preciser qu'il n'y à pas de couleur
#define JAUNE          0xFFE0
#define RED            0xF800
#define GREEN          0x07E0
#define NOIR           0x0000
#define BLANC          0xFFFF
#define VERTCLAIR      0xEFE0
#define VERTFONCE      0XE0E0
#define ROUGEFONCE     0XF200
#define BLUE           0x001F
#define BLEUFONCE      0X000F
#define BLEUCLAIR      0X07FF
...
#define GRAY0          0xE71C// (WORD)0b1110011100011100
#define GRAY1          0xC618//	   (WORD)0b1100011000011000
#define GRAY2          0xA514//   (WORD)0b1010010100010100
#define GRAY3          0x8410//  (WORD)0b1000010000010000
#define GRAY4          0x630C//  (WORD)0b0110001100001100
#define GRAY5          0x4208// (WORD)0b0100001000001000
#define GRAY6	       0x2104// (WORD)0b0010000100000100
...
#define ILI9341_NORMAL  			0x13//Normal Display Mode ON
#define ILI9341_MADCTL                          0x0B//Read Display MADCTL
...
extern void TM_ILI9341_DrawFilledRectangleFast(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint32_t color);
