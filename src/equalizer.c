...
#define TESTLENGTH FFT_FILTER_SIZE/2
...
static q31_t outputQ31[BLOCKSIZE];  
...
//int gainDB[5] = {2, 7, 3, -4, -9};
//int gainDB[5] = {2, 2, -4, -8, -9};
    ...
    {	 
      ...
      ** ------------------------------------------------------------------- */ 
      ...
      //arm_float_to_q31(inputF32 + (i*BLOCKSIZE), inputQ31, BLOCKSIZE);	   
        for( int j=0;j<BLOCKSIZE;++j ){
          inputQ31[j] = (signed long)inputF32[(i*BLOCKSIZE)+j]/16;
        }
      ...
      ** ------------------------------------------------------------------- */ 
      ...
      //arm_q31_to_float(outputQ31, outputF32 + (i * BLOCKSIZE), BLOCKSIZE);
        for( int j=0;j<BLOCKSIZE;++j ){
          outputF32[(i*BLOCKSIZE)+j] = (float)outputQ31[j]*8;
        }
